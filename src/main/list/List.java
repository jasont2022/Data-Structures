...
public interface List<E> extends Iterable<E> {
     ...
     * @return the element at the specified position in this list, otherwise return
     *         null
    ...
    /**
     * Deletes the element o from the list, removes the first occurrence of e in the
    ...
    /**
     * This method returns a string representation of the whole list in the format
     * [e_1]->[e_2]-> .... ->[e_n] for singly linked list [e_1]<->[e_2]<-> ...
     * <->[e_n] or null if list is empty
     * 
