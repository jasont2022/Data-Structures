...
/**
 * This class implements the List, Queue, and Stack interface using a doubly linked list, supports
 * null values to be inserted, deleted, and search
 *
 * @author Jason Tran
 */
public class DoublyLinkedList<E> implements List<E>, Queue<E>, Stack<E> {
   ...
   *     list does not contain the element Runtime: O(n)
   */
