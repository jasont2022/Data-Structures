 ...
 * @author Jason Tran
 * @param <E> the type of the elements in the doubly Linkedlist
 */
public class DoublyLinkedList<E> implements List<E>, Queue<E>, Stack<E> {
  ...
  /**
   * Private Inner Class to represent a Node<E> in a
   * doubly linked list
  ...
  /**
   * A private helper function that inserts
   * a new element into an empty list
