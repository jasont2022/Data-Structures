...
/**
 * This class implements the Tree Interface, a Binary Search Tree NOTE: No Duplicates of element
 * values are allowed
 *
 * @author Jason Tran
 */
public class BinarySearchTree<E extends Comparable<E>> implements Tree<E> {
  ...
  /**
   * Returns the minimum value in the BST, if the tree is empty return null
   *
   * @return the minimum value in the BST, otherwise null Runtime: O(n)
   */
  public E getMinimum() {
    if (isEmpty()) {
      return null;
  ...
  /**
   * Returns the maximum value in the BST, if the tree is empty return null
   *
   * @return the maximum value in the BST, otherwise null Runtime: O(n)
   */
  public E getMaximum() {
    if (isEmpty()) {
      return null;
  ...
  /**
   * Tells whether the BST is complete (Each level of the BST is filled from left to right, the last
   * level may only be filled from the far left as possible)
   *
  ...
  /**
   * Tells whether the BST is full (Every node other than the leaves has two children)
   *
  ...
  /**
   * Inserts a new node into the BST at the correct level and position and does not insert new nodes
   * with duplicate values
   *
   * @param e a new element to insert into the BST
   * @param node a node to start recursing from
   * @return the node that is inserted Runtime: O(n)
   */
   ...
   * @param node a node to start recursing from
   * @return the node to be deleted Runtime: O(n)
   */
   ...
   *
   * @return a list that contains the elements of the BST in pre-order Runtime: O(n)
   */
   ...
   *
   * @return a list that contains the elements of the BST in post-order Runtime: O(n)
   */
   ...
   *
   * @return a list that contains the elements of the BST in the level-order Runtime: O(n)
   */
