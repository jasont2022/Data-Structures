...
/**
 * This class implements the Tree Interface, a Binary Search Tree NOTE: No
 * Duplicates of element values are allowed
 *
 * @author Jason Tran
 */
public class BinarySearchTree<E extends Comparable<E>> implements Tree<E> {
    ...
    /**
     * Tells whether the BST is full or not, Runtime: O(n)
     *
     * @param node the node to start recursing over
     * @return true if the BST is full, otherwise false
     */
    ...
    /**
     * Inserts a new node into the BST at the correct level and position and does
     * not insert new nodes with duplicate values, Runtime: O(n)
     *
    ...
    /**
     * Returns a list with elements in order from the BST, Runtime: O(n)
     *
    ...
    /**
     * Returns a list with elements pre-order from the BST, Runtime: O(n)
     *
    ...
    /**
     * Returns a list with elements post-order from the BST, Runtime: O(n)
     *
    ...
    /**
     * Returns a list with elements level-order from the BST, Runtime: O(n)
     *
