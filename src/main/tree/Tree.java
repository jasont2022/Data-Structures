...
public interface Tree<E extends Comparable<E>> {
  ...
  /**
   * Calculates the height of the tree which is the length longest path from the root to a leaf in
   * the tree
   *
  ...
  /** Removes all of the elements from this tree, the tree will be empty as a result of this call */
  public void clear();
  ...
  /**
   * An Enum class for the iterator type Depending on which type the iterator will iterate in that
   * order
   */
  ...
  /**
   * Returns an iterator over the elements in this tree, depending on the order of iteration
   *
  ...
  /**
   * Returns a string representation of the whole tree in the format: root / \ node node / \ / \
