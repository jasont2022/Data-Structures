...
public interface Tree<E extends Comparable<E>> {
    ...
    /**
     * Removes all of the elements from this tree, the tree will be empty as a
     * result of this call
     */
    public void clear();
     ...
     *
     * @return an array containing all of the elements in this tree in proper
     *         sequence
     */
    ...
    /**
     * Returns a string representation of the whole tree in the format: root / \
     * node node / \ / \ .............. or null if tree is empty
     *
