...
public class ArrayStack<E> implements Stack<E> {
    ...
    /**
     * This returns the underlying array, Runtime: O(1)
     *
    ...
    /**
     * This returns the head of the stack, Runtime: O(1)
     *
    ...
    /**
     * {@inheritDoc} When the size is less than a 1/4 of capacity, the array will
     * resize a half of its capacity, Runtime: Amortized O(1), Worst Case O(n)
     */
    @Override
    public E pop() {
        if (isEmpty()) {
