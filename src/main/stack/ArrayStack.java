...
/**
 * This class implements the stack interface using a resizable generic array, supports null elements
...
public class ArrayStack<E> implements Stack<E> {
   ...
   *
   * @return the position of the head in the stack Runtime: O(1)
   */
  public int getHead() {
    return head;
  }
  ...
  /**
   * {@inheritDoc} When the size is less than a 1/4 of capacity, the array will resize a half of its
