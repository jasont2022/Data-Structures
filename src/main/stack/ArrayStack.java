...
/**
 * This class implements the stack interface using a resizable generic
...
public class ArrayStack<E> implements Stack<E> {
   ...
   * @return the positon of the head in the stack
   * Runtime: O(1)
   */
  public int getHead() {
    return head;
  ...
  /**
   * {@inheritDoc}
   * When the size is less than a 1/4 of capacity, 
   * the array will resize a half of its capacity
   * Runtime: Amortized O(1), Worst Case O(n)
   */
  @Override
  public E pop() {
