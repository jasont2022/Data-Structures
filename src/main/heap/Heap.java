...
public interface Heap<E extends Comparable<E>> extends Iterable<E> {
  ...
  /** Deletes all the elements in the heap, the heap will be empty after this call returns */
  public void clear();

  /**
   * Returns an array containing all of the elements in this heap in proper sequence in order
   * traversal
   *
   * @return an array containing all of the elements in this heap in proper sequence
   */
  public Object[] toArray();

  /**
   * Returns an iterator over the elements in this heap, performing a BFS/level order traversal
   *
  ...
  /**
   * Returns a string representation of the whole heap in the format [h_1, h_2, ...., h_n]
   *
