...
/**
 * This class implements the Heap Interface using a Binary Max Heap with ArrayList and HashMap for
 * faster operations (in terms of Runtime), this implementation does not support null elements
 *
