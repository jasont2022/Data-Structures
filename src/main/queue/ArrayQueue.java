...
public class ArrayQueue<E> implements Queue<E> {
    ...
    /**
     * Returns the underlying array, Runtime: O(1)
     *
    ...
    /**
     * Returns the head of the queue, Runtime: O(1)
     *
    ...
    /**
     * Returns the tail of the queue, Runtime: O(1)
     *
     * @return the position of the head in the queue
     */
    public int getTail() {
    ...
    /**
     * {@inheritDoc} When the size is less than a quarter of capacity, the array
    ...
    /**
     * Helper method that resizes the underlying array and unwinds the queue, so
     * that head points at the beginning of the array, Runtime: O(n)
     *
