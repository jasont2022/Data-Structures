...
/**
 * This class implements the queue interface using a resizable generic array, supports null elements
...
public class ArrayQueue<E> implements Queue<E> {
   ...
   *
   * @return the position of the head in the queue Runtime: O(1)
   */
  public int getHead() {
    return head;
  }
   ...
   * down by half Runtime: Amortized O(1), Worst Case O(n)
   */
  @Override
  public E poll() {
    if (isEmpty()) {
  ...
  /**
   * Helper method that resizes the underlying array and unwinds the queue, so that head points at
