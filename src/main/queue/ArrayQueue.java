...
/**
 * This class implements the queue interface using a resizable generic
...
public class ArrayQueue<E> implements Queue<E> {
   ...
   * @return the positon of the head in the queue
   * Runtime: O(1)
   */
  public int getHead() {
    return head;
   ...
   * underyling array and unwinds the queue, 
   * so that head points at the beginning of the array
