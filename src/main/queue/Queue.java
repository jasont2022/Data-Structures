...
public interface Queue<E> extends Iterable<E> {
    ...
    /**
     * Deletes all the elements in the queue, the queue will be empty after this
     * call returns
     */
    public void clear();
    ...
    /**
     * Returns a string representation of the whole queue in the format [q_1, q_2,
     * ...., q_n] or [] if the queue is empty
     *
     * @return the string format of the queue
     */
