...
public interface Queue<E> extends Iterable<E> {
   ...
   * possible to do so immediately without violating 
  ...
  /**
   * Removes the head element of this queue or returns 
   * null if the queue is empty
   * @return the head element of this queue otherwise 
   *         return null if queue if empty
   */
  public E poll();
  ...
  /**
   * This method deletes all the elements in the queue, the
   * queue will be empty after this call returns
   */
  public void clear();

  /**
   * Returns an iterator over the elements in this queue, ordered from
   * head to last
  ...
  /**
   * This method returns a string representation of the whole queue
   * in the format [q_1, q_2, ...., q_n] or [] if the queue is empty
