...
/**
 * This class implements the set interface using a resizable generic array, also supports null
 * elements to be insert, search, and delete in the array Another possible implementation of this
 * class, is using the ArrayImpl class to implement the methods
 *
 * @author Jason Tran
 */
...
public class ArraySet<E> implements Set<E> {
  ...
  /**
   * {@inheritDoc} When the size is at capacity, the array will resize double its capacity Runtime:
   * O(n)
   */
  @Override
  ...
  /**
   * This method removes the element at the specified index, shifts any subsequent elements to the
   * left
   *
   * @param index the index in the array
   * @return the element at that index Runtime: O(n)
   */
