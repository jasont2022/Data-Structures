...
public interface Set<E> extends Iterable<E> {
    ...
    /**
     * Adds the specified element to the set, if the set contains the
     * element, the set will not be modify
     * 
    ...
    /**
     * Takes the union between two sets, the union of a set is the
     * combination of two sets, but not including intersecting elements
     * 
    ...
    /**
     * Takes the intersection between two sets, the intersection of a
     * set is the combination of two sets, taking elements that are present in both
     * sets
     * 
    ...
    /**
     * Takes the difference between two sets, elements that are in this
     * set and not the other set are to be returned in a set
     * 
    ...
    /**
     * Takes the subset between two sets, test whether this set is a
     * subset of a different set
     * 
