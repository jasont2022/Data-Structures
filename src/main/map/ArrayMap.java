...
/**
 * This class implements the map Interface using a resizable generic array, this
 * class supports null keys NOTE: Did not use for-each loop because of null
...
public class ArrayMap<K, V> implements Map<K, V> {
    ...
    /**
     * This is a helper function to remove an entry from the map, when the size is
