...
public interface Map<K, V> {
     ...
     * @return the value to which the key is mapped otherwise null if no mapping for
     *         the key
     */
    ...
    /**
     * Deletes all the elements in the map, the map will be empty after this call
     * returns
     */
    public void clear();
    ...
    /**
     * This method returns a string representation of the whole map in the format
     * {(k_1,v_1), (k_2,v_2), ... (k_n,v_n)} or {} if the map is empty
     *
