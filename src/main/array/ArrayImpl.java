...
/**
 * This class implements the array interface using a resizable generic array, supports null elements
 * to be insert, search, and delete in the array
 *
 * @author Jason Tran
 * @see Array
 */
...
public class ArrayImpl<E> implements Array<E> {
  ...
  /**
   * Returns the index of o at the last occurrence in the array, otherwise return -1 if o is not in
   * the array
   *
  ...
  /**
   * A helper function to check if index is in range, if not, throws an IllegalArgumentException
   *
