...
public class ArrayImpl<E> implements Array<E> {
    ...
    /**
     * Returns the index of o at the last occurrence in the array, otherwise return
     * -1 if o is not in the array, Runtime: O(n)
     *
    ...
    /**
     * A helper function to check if index is in range, if not, throws an
     * IllegalArgumentException, Runtime: O(1)
     *
