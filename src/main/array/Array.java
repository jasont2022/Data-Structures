...
public interface Array<E> extends Iterable<E> {
  ...
  /**
   * Removes the element at the specified index, shifts any subsequent elements to the left
   *
   * @param index the index in the array
  ...
  /**
   * Deletes the element o from the array, removes the first occurrence of e in the array
   *
  ...
  /** Deletes all the elements in the array, the array will be empty after this call returns */
  public void clear();

  /**
   * Returns an array containing all of the elements in this list in proper sequence (from first to
   * last element), must allocate a new array
   *
  ...
  /**
   * Returns an iterator over the elements in this array, ordered from first to last
   *
  ...
  /**
   * Returns a string representation of the whole array in the format [a_1, a_2, ...., a_n]
   *
