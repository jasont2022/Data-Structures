...
public interface Array<E> extends Iterable<E> {
  ...
  /**
   * This method returns the index of element o
   * If there are duplicates return the first index of o
  ...
  /**
   * This method gets the specfic element at index
   * array[index]
  ...
  /**
   * This method deletes the element o from the array, removes the 
   * first occurancee of e in the array
  ...
  /**
   * This method deletes all the elements in the array, the
   * array will be empty after this call returns
   */
  public void clear();

  /**
   * Returns an array containing all of the elements in this list
   * in proper sequence (from first to last element), must allocate 
   * a new array
  ...
  /**
   * Returns an iterator over the elements in this array, ordered from
   * first to last
  ...
  /**
   * This method returns a string representation of the whole array 
   * in the format [a_1, a_2, ...., a_n]
